...
public class SecurityConfiguration {
    ...
    public UserDetailsService userDetailsService() {
        UserDetails administrator = User.builder()
                .username("admin")
                .password("{bcrypt}$2a$12$qIFnLsnRNi9uZ89ey4gM1e22t1Ce2j13qg98/SC614Ea.Or5GfnCK")
                .roles("ADMIN")
                .build();
        UserDetails guest = User.builder()
                .username("guest")
                .password("{bcrypt}$2a$12$MRK.Bq31TgatvyTWtB2odusG6J3rovSu4jwwTG64Od/lUEw/nXcJS")
                .roles("GUEST")
                .build();
